  ...
  return t(this, void 0, void 0, (function* () {
    ...
    return (function(e3, i3) {
      t(this, void 0, void 0, (function* () {
        ...
        let r2 = 0, o2 = 0;
        const a2 = (e4) => t(this, void 0, void 0, (function* () {
          r2 += (null == e4 ? void 0 : e4.length) || 0;
          const t2 = Math.round(r2 / n3 * 100);
          i3(t2);
        })), h2 = () => t(this, void 0, void 0, (function* () {
          if (o2++ > 1e5) return void console.error("Fetcher: Maximum iterations reached, stopping read loop");
          let t2;
          try {
            t2 = yield s3.read();
          } catch (t3) {
...
var h = class _h extends e {
  ...
  initDrag() {
    this.dragUnsubscribe || (this.dragUnsubscribe = (function(t2, e2, i2, s2, n2 = 3, r2 = 0, o2 = 100) {
      if (!t2) return () => {
      };
...
var u = class _u extends a {
  ...
  constructor(t2) {
    ...
    Promise.resolve().then((() => {
      ...
      (s2 || t3 && e3) && this.load(s2, t3, e3).catch(((t4) => {
        console.error("WaveSurfer initial load error:", t4);
      }));
    }));
  }
  ...
  initRendererEvents() {
    ...
    })));
    {
      ...
      const e2 = this.renderer.on("drag", ((e3) => {
        ...
        let i2;
        this.renderer.renderProgress(e3), clearTimeout(t2), this.isPlaying() ? i2 = 0 : true === this.options.dragToSeek ? i2 = 200 : "object" == typeof this.options.dragToSeek && void 0 !== this.options.dragToSeek && (i2 = this.options.dragToSeek.debounceTime), t2 = setTimeout((() => {
          this.seekTo(e3);
        }), i2), this.emit("interaction", e3 * this.getDuration()), this.emit("drag", e3);
      }));
  ...
  loadAudio(e2, s2, n2, r2) {
    return t(this, void 0, void 0, (function* () {
      var t2;
      if (this.emit("load", e2), !this.options.media && this.isPlaying() && this.pause(), this.decodedData = null, this.stopAtPosition = null, null === (t2 = this.abortController) || void 0 === t2 || t2.abort(), this.abortController = null, !s2 && !n2) {
        ...
        s2 = yield o.fetchBlob(e2, i2, t3);
        const n3 = this.options.blobMimeType;
        n3 && (s2 = new Blob([s2], { type: n3 }));
      }
      this.setSrc(e2, s2);
